...
test('validates links are unique', () => {
  ...
  expect(() => validateUnique('/foo', `/foo https://foo.com`)).toThrowErrorMatchingInlineSnapshot(`"A link with this code already exists. It points to https://foo.com"`);
});
test('validates url is valid', () => {
  expect(() => validateUrl('https://blah.com')).not.toThrow();
  expect(() => validateUrl('blah')).toThrowErrorMatchingInlineSnapshot(`"Invalid URL: blah"`);
});
